...
- In **On the court**, turn over my player's card under the intro: my NBA 2K26 MyCAREER build on a card like the game's builds screen, in G.O.A.T. gold. Its tab goes to the whole build and my jumper (Mochi, with its grades), then to all 35 badges and my 4 personality badges (point at one, or tap it, to read what it does; the icons are my own, one per badge group), then to my moves: my dribble and post animations. My player also shows on Malolos Rush's start screen.
- The coach's board beside it draws three power forward plays: Back door, Horns (pick and pop) and 5-out post. Tap a tab under the board to draw one, or point at a word on the wall (tap it on a phone) to call up its play. Slow-mo draws it at a walk; a caption under the court says what each step is. After a crash, **Share my run** makes a picture of the crash with your distance and a link back (the share sheet on a phone; copied on a computer, ready to paste into a chat). The link, `…/#malolos-rush`, opens the game straight away.
