...
- In **On the court**, turn over my player's card under the intro: my NBA 2K26 MyCAREER build on a card like the game's builds screen, in G.O.A.T. gold. Its tab goes to the whole build and my jumper, then to all 35 badges.
- The coach's board beside it draws three power forward plays: Back door, Horns (pick and pop) and 5-out post. Tap a tab under the board to draw one. After a crash, **Share my run** makes a picture of the crash with your distance and a link back (the share sheet on a phone; copied on a computer, ready to paste into a chat). The link, `…/#malolos-rush`, opens the game straight away.
