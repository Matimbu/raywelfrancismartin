...
- In **On the court**, turn over my player's card under the intro: my NBA 2K26 MyCAREER build on a card like the game's builds screen, in G.O.A.T. gold. Its tab goes to the whole build and my jumper (Mochi, with its grades), then to all 35 badges and my 4 personality badges (point at one, or tap it, to read what it does; the icons are my own, one per badge group), then to my moves: my dribble and post animations. **Full view** under it (like under the starting five) opens the card big in the middle of the screen, with **Save as picture** (a 1080 x 1350 post: the share sheet on a phone, a download on a computer). My player also shows on Malolos Rush's start screen.
- The coach's board beside it draws three power forward plays: Back door (the cut ends in an easy layup), Horns (pick and pop) and 5-out post. Tap a tab under the board to draw one, or point at a word on the wall (tap it on a phone) to call up its play. Slow-mo draws it at a walk; a caption under the court says what each step is. **Guess the play** draws one with no name on it: pick it with the tabs and keep a streak going. The corner button opens the board big, in the middle of the screen.
