...
- Press **Play** on Malolos Rush in Crafts: a tiny three-lane runner through Malolos at sunset, playing a student from my capstone. Swipe to change lanes and swipe up to jump the barriers (drag with the mouse on a computer, or use the arrows and Space) and grab the coins. A jeepney ends the run (they honk when one's coming down your lane); clip a barrier and a guard gives chase, and clipping another before he drops back gets you caught. An ensaymada pulls the coins to you for a few seconds. On the way: Barasoain Church at 500 m, the Malolos Cathedral at 1000 m and Casa Real at 1500 m, each lighting up with bells or a fanfare as you reach it, while the sky turns to night. Your score is a point a metre and 10 a coin, and after a new best you can post it to the leaderboard. Add `?fps` to the address to see the frame rate.
- In **On the court**, turn over my player's card under the intro: my NBA 2K26 MyCAREER build on a card like the game's builds screen, in G.O.A.T. gold. Its tab goes to the whole build and my jumper (Mochi, with its grades), then to all 35 badges and my 4 personality badges (point at one, or tap it, to read what it does; the icons are my own, one per badge group), then to my moves: my dribble and post animations. **Full view** under it opens the card big in the middle of the screen, with **Save as picture** (a 1080 x 1350 post: the share sheet on a phone, a download on a computer). My player also shows on Malolos Rush's start screen.
- The coach's board beside it draws three power forward plays: Back door, Horns (pick and pop) and 5-out post. Tap a tab under the board to draw one, or point at a word on the wall (tap it on a phone) to call up its play. Slow-mo draws it at a walk; a caption under the court says what each step is. **Guess the play** draws one with no name on it: pick it with the tabs and keep a streak going. After a crash, **Share my run** makes a picture of the crash with your distance and a link back (the share sheet on a phone; copied on a computer, ready to paste into a chat). The link, `…/#malolos-rush`, opens the game straight away.
